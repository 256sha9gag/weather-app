...
const LightThemeIcon = () => {
  return (
    <svg data-id='light' width="64" height="32" viewBox="0 0 64 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M1 16C1 7.71573 7.71573 1 16 1H48C56.2843 1 63 7.71573 63 16C63 24.2843 56.2843 31 48 31H16C7.71573 31 1 24.2843 1 16Z" fill="white" stroke="#ACACAC" strokeWidth="2"/>
